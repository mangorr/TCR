...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'نطاق بريدك الإلكتروني يتبع لمؤسسة، لإعادة تعيين كلمة المرور، رجاءً تواصل مع أحد مسؤولي النظام.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'المصادقة المتعددة مطلوبة ولكن جهازك غير مسجل، رجاء سجّل جهازك قبل المضي قدماً.',
      'lock.mfa_invalid_code': 'رمز خاطئ، رجاءً أعد المحاولة.',
      password_change_required: 'يجب تحديث كلمة المرور لأنها المرة الأولى للدخول، أو لانتهاء صلاحية كلمة المرور.',
      password_leaked: 'لقد اكتشفنا مشكلة أمنية محتملة في هذا الحساب. لحماية حسابك ، قمنا بحظر هذا الدخول. تم إرسال بريد إلكتروني عن كيفية رفع الحظر عن حسابك.',
      too_many_attempts: 'تم حظر حسابك بعد عدة محاولات متتالية للدخول.',
      session_missing: 'لم نتمكن من إكمال طلب المصادقة. رجاءً أعد المحاولة بعد إغلاق جميع مربعات الحوار المفتوحة.',
      'hrd.not_matching_email': 'يرجى استخدام بريد الشركة الإلكتروني للدخول.',
      too_many_requests: 'نحن آسفون. هناك الكثير من الطلبات في الوقت الحالي. يرجى إعادة تحميل الصفحة وحاول مرة أخرى. إذا استمر هذا الأمر ، يرجى إعادة المحاولة لاحقًا.',
  ...
  forgotPasswordInstructions: 'رجاء أدخل بريدك الإلكتروني. سنرسل لك رسالة لإعادة تعيين كلمة المرور.',
  ...
  passwordlessEmailAlternativeInstructions: 'وإلا، أدخل بريدك الإلكتروني للدخول <br/>أو أنشئ حساباً',
