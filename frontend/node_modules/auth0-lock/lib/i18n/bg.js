...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Вашият имейл е част от служебн доставчик на идентичност. Моля свържете се с администратора по сигурността, за да смените паролата си.'
    },
    login: {
      ...
      'lock.network': 'Не успяхме да се свържем със сървъра. Моля проверете вашата връзка с интернет и опитайте отново.',
      'lock.popup_closed': 'Диалога е затворен. Моля опитайте отново.',
      'lock.unauthorized': 'Не получихте разрешение. Моля опитайте отново.',
      'lock.mfa_registration_required': 'Изисква се неколкократно удостоверяване на автентичност, но вашето устройство не е включено. Моля включете го преди да продължите.',
      'lock.mfa_invalid_code': 'Грешен код. Моля опитайте отново.',
      password_change_required: 'Трябва да смените паролата си, защото това е първият път когато влизате в профила си, или паролата Ви е изтекла.',
      password_leaked: 'Засякохме потенциален проблем със сигурността на този профил. За да предпазим профила Ви, блокирахме потребителското Ви име. Ще получите имейл с инструкции как да деблокирате профила си.',
      too_many_attempts: 'Вашият акаунт е блокиран след множество последователни опити да влезете в профила си.',
      session_missing: 'Не успяхме да удостоверим Вашата самоличност. Моля опитайте отново след като затворите всички прозорци',
      'hrd.not_matching_email': 'Моля използвайте Вашия служебен имейл за да влезете в профила си.',
      too_many_requests: 'Съжаляваме. Достигнахте лимита на опити за влизане. Моля, презаредете страницата и опитайте отново. Ако това продължи, моля, опитайте отново по-късно.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Моля, приемете Общите условия по-долу, за да продължите.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Моля въведете имейл адреса си. Ще Ви изпратим имейл, за да промените паролата си.',
  ...
  passwordlessEmailAlternativeInstructions: 'В противен случай, напишете Вашия имейл за да влезете в профила си<br/>, или за да създадете профил',
  ...
  signUpTerms: 'При регистрация, Вие се съгласявате с нашата политика на потребителя и политика за защита на личните данни.',
  ...
  mfaLoginInstructions: 'Моля въведете кода за проверка, който беше създаден от приложението на Вашия мобилен телефон.',
  mfaSubmitLabel: 'Вход',
