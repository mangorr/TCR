...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: "El domini del vostre correu electrònic forma part d'un proveïdor d'identitat empresarial. Per restablir la contrasenya, consulteu l'administrador de seguretat."
    },
    login: {
      ...
      too_many_requests: 'Ho sentim. Ara hi ha massa sol·licituds ara mateix. Torneu a carregar la pàgina i torneu-ho a provar. Si això persisteix, torneu-ho a provar més tard.',
  ...
  signUpTerms: "En inscriure's, accepteu les nostres condicions de servei i la nostra política de privadesa.",
