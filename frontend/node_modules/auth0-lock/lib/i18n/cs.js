...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Doména vašeho e-mailu je součástí poskytovatele podnikové identity. Chcete-li obnovit heslo, obraťte se na svého správce zabezpečení.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'Je požadováno vícefaktorové ověření, ale vaše zařízení není registrováno. Prosím registrujte jej, než budete pokračovat.',
      'lock.mfa_invalid_code': 'Chybný kód. Prosím zkuste to znovu.',
      password_change_required: 'Musíte si aktualizovat si své heslo, protože je toto vaše první přihlášení, nebo platnost vašeho hesla vypršela.',
      password_leaked: 'Detekovali jsme, že tento účet může být ohrožen. Abychom váš účet ochránili, zablokovali jsme toto přihlášení. Zaslali jsme vám e-mail s instrukcemi, jak svůj účet odblokovat.',
      too_many_attempts: 'Váš účet byl zablokován z důvodu velkého počtu pokusů o přihlášení.',
      too_many_requests: 'Omlouváme se. Právě teď je příliš mnoho žádostí. Načtěte stránku znovu a zkuste to znovu. Pokud to trvá, zkuste to znovu později.',
      session_missing: 'Nemohli jsme dokončit váš požadavek na ověření. Zkuste to znovu po zavření všech otevřených dialogových oken.',
  ...
  forgotPasswordInstructions: 'Prosím zadejte svou e-mailovou adresu. Pošleme vám e-mail, díky němuž si budete moct změnit heslo.',
  ...
  passwordlessEmailAlternativeInstructions: 'Případně zadejte e-mail pro přihlášení,<br/>nebo vytvoření účtu',
  ...
  passwordlessSMSAlternativeInstructions: 'Případně zadejte telefon pro přihlášení<br/>nebo vytvoření účtu',
