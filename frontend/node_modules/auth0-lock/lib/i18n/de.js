...
exports.default = {
  error: {
    ...
    login: {
      ...
      'lock.mfa_registration_required': 'Eine Multifaktor-Authentifizierung ist erforderlich, aber Ihr Gerät ist nicht registriert. Bitte registrieren Sie es, bevor Sie fortfahren.',
      ...
      too_many_requests: 'Es tut uns leid. Im Moment gibt es zu viele Anfragen. Bitte laden Sie die Seite neu und versuchen Sie es erneut. Wenn dies weiterhin der Fall ist, versuchen Sie es später erneut.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Bitte stimmen Sie den untenstehenden Nutzungsbedingungen zu, um fortzufahren.'
    }
  },
  success: {
  ...
  passwordlessEmailAlternativeInstructions: 'Andernfalls geben Sie Ihre E-Mail-Adresse ein,<br/>um sich anzumelden oder ein Konto zu erstellen',
  passwordlessEmailCodeInstructions: 'Eine E-Mail mit dem Code wurde an %s gesendet.',
  passwordlessEmailInstructions: 'Geben Sie Ihre E-Mail-Adresse ein, um sich anzumelden<br/>oder ein Konto zu erstellen',
  ...
  unrecoverableError: 'Etwas ist schiefgelaufen.<br/>Bitte kontaktieren Sie den technischen Support.',
  ...
  signUpTerms: 'Mit der Anmeldung stimmen Sie unseren Nutzungsbedingungen und Datenschutzbestimmungen zu.',
