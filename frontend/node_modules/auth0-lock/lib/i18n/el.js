...
exports.default = {
  error: {
    forgotPassword: {
      ...
      'lock.fallback': 'Λυπούμαστε, ανεπιτυχής έκβαση. Κάτι πήγε στραβά κατά την επεξεργασία του αιτήματος.',
      enterprise_email: 'Το domain του email σας ανήκει σε επιχείρηση. Για να αντικαταστήσετε τον κωδικό πρόσβασής σας, ζητήστε το από τον υπεύθυνο διαχειριστή.'
    },
    login: {
      ...
      'lock.network': 'Αδυναμία επικοινωνίας με τον διακομιστή. Ελέγξτε τη σύνδεση σας και δοκιμάστε ξανά.',
      'lock.popup_closed': 'Το αναδυόμενο παράθυρο έκλεισε. Προσπαθήστε ξανά.',
      'lock.unauthorized': 'Απορρίφτηκε. Προσπάθησε ξανά.',
      'lock.mfa_registration_required': 'Απαιτείται ταυτοποίηση δύο βημάτων. Παρακαλούμε κατοχυρώστε την συσκευή σας πριν συνεχίσετε.',
      'lock.mfa_invalid_code': 'Λάθος κωδικός. Παρακαλώ προσπαθήστε ξανά.',
      password_change_required: 'Πρέπει να αντικαταστήσετε τον κωδικό πρόσβασής σας, επειδή συνδέεστε για πρώτη φορά ή ο κωδικός σας έχει λήξει.',
      password_leaked: 'Εντοπίσαμε πιθανό πρόβλημα ασφαλείας στον λογαριασμό σας. Για να τον προστατεύσουμε, τον απενεργοποιήσαμε. Αποστείλαμε email με οδηγίες επανενεργοποίησης',
      too_many_attempts: 'Ο λογαριασμός σας έχει απενεργοποιηθεί λόγω υπέρβασης του ορίου επιτρεπόμενων προσπαθειών σύνδεσης.',
      session_missing: 'Δεν ήταν δυνατή η ολοκλήρωση του αιτήματος επαλήθευσης ταυτότητας. Δοκιμάστε ξανά μετά το κλείσιμο όλων των ανοιχτών παραθύρων διαλόγου',
      'hrd.not_matching_email': 'Παρακαλώ χρησιμοποιήστε το εταιρικό σας email για να συνδεθείτε.',
      too_many_requests: 'Λυπόμαστε. Υπάρχουν πολλά αιτήματα τώρα. Επαναλάβετε τη φόρτωση της σελίδας και προσπαθήστε ξανά. Αν αυτό παραμείνει, δοκιμάστε ξανά αργότερα.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Αποδεχτείτε τους Όρους Παροχής Υπηρεσιών παρακάτω για να συνεχίσετε.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Παρακαλώ εισάγετε το email σας και θα σας στείλουμε email για να αντικαταστήσετε τον κωδικό σας.',
  ...
  passwordStrength: {
    containsAtLeast: 'Πρέπει να περιέχει τουλάχιστον %d τύπους από τις ακόλουθες %d κατηγορίες χαρακτήρων:',
    identicalChars: 'Δεν επιτρέπονται περισσότεροι από %d ίδιοι χαρακτήρες συνεχόμενα (π.χ. δεν επιτρέπεται %s)',
  ...
  passwordlessEmailAlternativeInstructions: 'Διαφορετικά, για να συνδεθείτε εισάγετε το email σας <br/> ή δημιουργήστε έναν λογαριασμό',
  passwordlessEmailCodeInstructions: 'Εmail με τον κωδικό πρόσβασης έχει σταλεί στο %s.',
  passwordlessEmailInstructions: 'Για να συνδεθείτε εισάγετε το email σας <br/> ή δημιουργήστε έναν λογαριασμό',
  ...
  signUpTerms: 'Με την εγγραφή σας, συμφωνείτε με τους όρους παροχής υπηρεσιών και την πολιτική απορρήτου.',
  ...
  usernameFormatErrorHint: 'Επιλέξτε: 1) αριθμούς 2) από τα γράμματα %d-%d 3) από τους ακόλουθους χαρακτήρες: "_", ".", "+", "-"',
  ...
  mfaLoginInstructions: 'Εισάγετε τον κωδικό επαλήθευσης που δημιούργησε η εφαρμογή του κινητού σας.',
