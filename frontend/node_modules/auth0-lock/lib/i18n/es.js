...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'El dominio de su correo electrónico es parte de un proveedor de identidad Enterprise. Para restablecer su contraseña, consulte a su administrador de seguridad.'
    },
    login: {
      ...
      password_leaked: 'Este intento ha sido bloqueado ya que usted utilizó la misma contraseña para registrarse en otra aplicación que tuvo una filtración reciente de datos. Hemos enviado un email con instrucciones para desbloquear la cuenta.',
      too_many_attempts: 'Su cuenta ha sido bloqueada luego de múltiples intentos de inicio de sesión consecutivos.',
      'lock.mfa_registration_required': 'Se requiere autenticación de dos factores. Por favor registre su dispositivo antes de continuar.',
      ...
      too_many_requests: 'Lo sentimos. Hay demasiados peticiones en estos momentos. Por favor, recargue la página y vuelva a intentarlo. Si persiste, por favor vuelva a intentarlo más tarde.',
  ...
  usernameFormatErrorHint: 'Use %d-%d letras, números y los siguientes caracteres: "_", ".", "+", "-"',
