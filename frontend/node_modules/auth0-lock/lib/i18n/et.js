...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Teie e-posti domeen kuulub ettevõtte identiteedi pakkuja juurde. Parooli lähtestamiseks lugege oma turvameedet.'
    },
    login: {
      ...
      password_change_required: 'Parooli vahetamine on kohustuslik, sest sa logid sisse esimest korda või parool on aegunud.',
      ...
      too_many_requests: 'Vabandame. Praegu on päringuid liiga palju. Laadige leht uuesti ja proovige uuesti. Kui see jätkub, proovige hiljem uuesti.',
