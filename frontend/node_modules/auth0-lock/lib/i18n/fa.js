...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'دامنه ایمیل شما بخشی از ارائهدهنده هویت سازمانی است. برای بازنشانی گذرواژه خود، لطفا به مدیر امنیتی خود مراجعه کنید.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'احراز هویت چند مرحله ای لازم است ، اما دستگاه شما ثبت نشده است، لطفا دستگاه خود را ثبت کنید.',
      ...
      too_many_requests: 'ما متاسفیم. در حال حاضر درخواست های زیادی وجود دارد لطفا صفحه را مجددا بارگذاری کنید و دوباره تلاش کنید. اگر این کار ادامه دارد، لطفا بعدا دوباره امتحان کنید.',
