...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'הדומיין של כתובת המייל שלך הוא חלק מספק זהויות ארגוני. על מנת לאפס את הסיסמא שלך, אנא צור קשר עם אחראי האבטחה בארגון.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'הזדהות דו-שלבית דרושה אבל המכשיר שברשותך לא רשום. אנא הרשם לפני שתמשיך.',
      'lock.mfa_invalid_code': 'קוד שגוי, אנא נסה שנית.',
      password_change_required: 'עליך לעדכן את הסיסמא שלך מכיוון שזו הפעם הראשונה שאתה נכנס למערכת, או מכיוון שפג תוקף הסיסמא שברשותך.',
      password_leaked: 'בחשבון זה זוהתה בעיית אבטחה פוטנציאלית. על מנת להגן על החשבון שלך, ניסיון הכניסה הנוכחי נחסם. נשלח מייל המכיל הוראות לפתיחת החשבון לשימוש.',
      too_many_attempts: 'חשבונך נחסם לאחר ניסיונות מרובים ורצופים לכניסה.',
      session_missing: 'לא ניתן להשלים את ניסיון ההזדהות. אנא נסה שנית לאחר סגירת כל החלונות הפתוחים.',
      'hrd.not_matching_email': 'על מנת להיכנס, אנא השתמש בחשבון המייל הארגוני שלך',
      too_many_requests: 'אנחנו מצטערים. יש יותר מדי בקשות כרגע. טען מחדש את הדף ונסה שוב. אם פעולה זו נמשכת, נסה שוב מאוחר יותר.',
