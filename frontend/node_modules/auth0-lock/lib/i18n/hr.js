...
exports.default = {
  error: {
    forgotPassword: {
      ...
      'lock.fallback': 'Ispričavamo se, ali nešto je pošlo po zlu tijekom obrade zahtjeva za promjenom lozinke.',
      enterprise_email: 'Domena vaše e-pošte dio je davatelja identiteta tvrtke. Da biste poništili zaporku, obratite se svom administratoru za sigurnost.'
    },
    login: {
      ...
      'lock.network': 'Nismo uspjeli dosegnuti poslužitelj. Provjerite svoju vezu i pokušajte ponovno.',
      'lock.popup_closed': 'Zatvoren skočni prozor. Pokušajte ponovno.',
      'lock.unauthorized': 'Dozvole nisu odobrene. Pokušajte ponovno.',
      'lock.mfa_registration_required': 'Potrebna je višečimbenična provjera autentičnosti, ali vaš uređaj nije prijavljen. Prijavite ga prije nastavka.',
      'lock.mfa_invalid_code': 'Pogrešan kôd. Pokušajte ponovno.',
      password_change_required: 'Trebate ažurirati svoju lozinku jer se prijavljujete prvi put ili jer je vaša lozinka istekla.',
      password_leaked: 'Otkrili smo mogući sigurnosni problem s ovim računom. Kako biste zaštitili svoj račun, blokirali smo ovu prijavu. Poslali smo vam elektroničku poruku s uputama za odblokiravanje vašeg računa.',
      too_many_attempts: 'Vaš je račun blokiran uslijed višestrukih uzastopnih pokušaja prijave.',
      session_missing: 'Zahtjev za provjerom autentičnosti nije se mogao završiti. Pokušajte ponovno nakon što zatvorite sve otvorene dijaloške okvire.',
      'hrd.not_matching_email': 'Upotrijebite svoju poslovnu adresu elektroničke pošte kako biste se prijavili.',
      too_many_requests: 'Žao nam je. Trenutno ima previše zahtjeva. Ponovo učitajte stranicu i pokušajte ponovno. Ako se to nastavi, pokušajte ponovno kasnije.',
  ...
  success: {
    ...
    forgotPassword: 'Upravo smo vam poslali elektroničku poruku kako biste vratili izvornu lozinku.',
  ...
  enterpriseActiveLoginInstructions: 'Upišite svoje poslovne pristupne podatke na mrežnom mjestu %s.',
  failedLabel: 'Neuspješno!',
  forgotPasswordTitle: 'Vraćanje vaše izvorne lozinke',
  forgotPasswordAction: 'Zaboravili ste lozinku?',
  forgotPasswordInstructions: 'Upišite svoju adresu elektroničke pošte. Poslat ćemo vam elektroničku poruku kako biste vratili izvornu lozinku.',
  ...
  passwordlessEmailAlternativeInstructions: 'U protivnom, upišite svoju adresu elektroničke pošte kako biste se prijavili<br/>ili napravite račun.',
  passwordlessEmailCodeInstructions: 'Elektronička poruka s kôdom poslana vam je na %s.',
  passwordlessEmailInstructions: 'Upišite svoju adresu elektroničke pošte kako biste se prijavili<br/>ili napravite račun.',
  ...
  usernameFormatErrorHint: 'Upotrijebite %d-%d slova, brojeve i sljedeće znakove: „_", ".", "+", "-"',
  ...
  mfaLoginInstructions: 'Upišite kôd za provjeru autentičnosti koji je stvorila vaša mobilna aplikacija.',
