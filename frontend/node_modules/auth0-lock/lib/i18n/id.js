...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Domain email Anda adalah bagian dari penyedia identitas Perusahaan. Untuk mengatur ulang kata sandi, harap lihat administrator keamanan Anda.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'Autentikasi multifaktor diperlukan tetapi perangkat Anda tidak terdaftar. Harap daftarkan perangkat sebelum melanjutkan.',
      'lock.mfa_invalid_code': 'Kode salah. Harap coba lagi.',
      password_change_required: 'Anda harus memperbarui kata sandi karena ini pertama kali Anda masuk log, atau karena kata sandi Anda kedaluwarsa.',
      password_leaked: 'Kami telah mendeteksi adanya masalah keamanan dengan akun ini. Untuk melindungi akun Anda, kami telah memblokir log ini. Email telah dikirimkan disertai instruksi untuk mengurungkan blokir akun Anda.',
      too_many_attempts: 'Akun Anda telah diblokir setelah mencoba masuk log berulang-ulang.',
      session_missing: 'Tidak bisa menyelesaikan permintaan autentikasi Anda. Harap coba lagi setelah menutup semua dialog yang terbuka.',
      ...
      too_many_requests: 'Kami meminta maaf. Ada terlalu banyak permintaan saat ini. Harap muat ulang halaman dan coba lagi. Jika ini terus berlanjut, silakan coba lagi nanti.'
    },
    passwordless: {
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Harap setujui Persyaratan Layanan di bawah ini untuk melanjutkan.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Harap masukkan alamat email Anda. Kami akan mengirimi Anda email untuk mengatur ulang kata sandi Anda.',
  ...
  passwordlessEmailAlternativeInstructions: 'Atau, masukkan email Anda untuk masuk<br/>atau buat akun',
