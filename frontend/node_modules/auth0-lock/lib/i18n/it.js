...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: "Il dominio della tua email fa parte di un provider di identità aziendale. Per reimpostare la password, consultare l'amministratore della sicurezza."
    },
    login: {
      ...
      too_many_requests: 'Ci dispiace. Ci sono troppe richieste in questo momento. Si prega di ricaricare la pagina e riprovare. Se persiste, riprova più tardi.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Si prega di accettare i Termini di servizio di seguito per continuare.'
    }
  },
  success: {
