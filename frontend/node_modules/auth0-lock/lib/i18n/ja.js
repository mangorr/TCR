...
exports.default = {
  error: {
    ...
    login: {
      ...
      'lock.mfa_registration_required': '多段階認証が必要ですが、デバイスが登録されていません。先にデバイスをご登録ください。',
      'lock.mfa_invalid_code': '不正なコードです。もう一度やり直してください。',
      password_change_required: '初めてのログインか、パスワードの期限切れのため、パスワードを更新する必要があります。',
      password_leaked: 'このアカウントはパスワード漏洩の可能性があるため、一時的にブロックされています。ブロックの解除方法についてのメールを送信しましたのでご確認ください。',
      ...
      too_many_requests: '申し訳ございません。今はあまりにも多くの要求があります。ページを再読み込みしてもう一度やり直してください。それでも解決しない場合は、後でもう一度やり直してください。',
  ...
  forgotPasswordInstructions: 'アカウントの登録メールアドレスをご入力ください。パスワード再設定用のリンクをメールします。',
  ...
  passwordlessEmailAlternativeInstructions: 'もしくはメールアドレスを入力してログインする、<br />またはアカウントを作成してください。',
  passwordlessEmailCodeInstructions: '%s へメールでコードが送信されました。',
  passwordlessEmailInstructions: 'メールアドレスを入力してログインする、<br />またはアカウントを作成してください。',
  passwordlessSMSAlternativeInstructions: 'もしくは電話番号を入力してログインする、<br />またはアカウントを作成してください。',
  passwordlessSMSCodeInstructions: '%s にSMSでコードが送信されました。',
  passwordlessSMSInstructions: '電話番号を入力してログインする、<br />またはアカウントを作成してください。',
  ...
  usernameFormatErrorHint: '%d-%d個の文字、数字、および以下の文字が使用可能です: "_"、 "."、 "+"、 "-"',
