...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Jūsų el.pašto domenas yra Enterprise tapatybės teikėjo dalis. Norėdami iš naujo nustatyti slaptažodį, apsilankykite pas savo saugumo administratorių.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'Multifaktorinis autentifikavimas yra būtinas, tačiau prietaisas nėra registruotas. Prašome jį užregistruoti prieš tęsiant.',
      'lock.mfa_invalid_code': 'Neteisingas kodas, bandykite dar kartą.',
      password_change_required: 'Jums reikia atnaujinti savo slaptažodį, nes prisijungiate pirmą kartą, arba slaptažodis yra negaliojantis.',
      password_leaked: 'Mes nustatėme galimą saugumo problemą su šia sąskaita. Norėdami apsaugoti jūsų sąskaitą, mes užblokuosime šį prisijungimą. Į jūsų el. paštą buvo išsiųsta instrukcija, kaip atblokuoti jūsų sąskaitą.',
      too_many_attempts: 'Jūsų sąskaita buvo užblokuota, po kelių iš eilės bandymų prisijungti.',
      session_missing: 'Nepavyko užbaigti jūsų autentifikavimo prašymo. Bandykite dar kartą uždarius visus atidarytus dialogo langus.',
      'hrd.not_matching_email': 'Prašome naudoti jūsų įmonės el.pašto adresą prisijungimui.',
      too_many_requests: 'Mes atsiprašome. Šiuo metu yra per daug užklausų. Atnaujinkite puslapį ir bandykite dar kartą. Jei tai išlieka, bandykite dar kartą vėliau.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Norėdami tęsti, sutikite su toliau pateiktomis paslaugų teikimo sąlygomis.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Įveskite jūsų el.pašto adresą. Mes atsiųsime jums laišką iš nustatyti nauja slaptažodį.',
  ...
  passwordlessEmailAlternativeInstructions: 'Arba įveskite el.pašto adresą prisijungti<br/>arba susikurti paskyrą',
  ...
  signUpTerms: 'Registruodamiesi jūs sutinkate su mūsų paslaugų teikimo sąlygomis ir privatumo politika.',
