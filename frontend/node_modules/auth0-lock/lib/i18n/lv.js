...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Jūsu e-pasta domēns ir daļa no uzņēmuma identitātes nodrošinātāja. Lai atiestatītu paroli, lūdzu, sazinieties ar administratoru.'
    },
    login: {
      ...
      'lock.network': 'Mēs nevarējās sazināties ar serveri. Pārbaudiet savienojumu un mēģiniet vēlreiz.',
      ...
      'lock.mfa_registration_required': 'Nepieciešama daudzfaktoru autentifikācija, taču jūsu ierīce nav reģistrēta. Reģistrējiet to pirms turpmākām darbībām.',
      'lock.mfa_invalid_code': 'Nepareizs kods. Lūdzu, mēģiniet vēlreiz.',
      password_change_required: 'Jums jāatjaunina parole, jo šī ir pirmā pieteikšanās reizi vai arī ir beidzies paroles derīguma termiņš.',
      password_leaked: 'Saistībā ar šo kontu atklājām iespējamu drošības problēmu. Lai aizsargātu jūsu kontu, esam bloķējuši šo lietotājvārdu. Tika nosūtīts e-pasta ziņojums ar norādījumiem par to, kā atbloķēt kontu.',
      too_many_attempts: 'Jūsu konts ir bloķēts pēc vairākiem secīgiem pieteikšanās mēģinājumiem.',
      session_missing: 'Nevarēja izpildīt jūsu autentifikācijas pieprasījumu. Lūdzu, mēģiniet vēlreiz pēc visu dialoglodziņu aizvēršanas',
      ...
      too_many_requests: 'Mums zel. Šobrīd ir pārāk daudz pieprasījumu. Lūdzu, atkārtoti ielādējiet lapu un mēģiniet vēlreiz. Ja tas joprojām pastāv, lūdzu, vēlāk mēģiniet vēlreiz.'
    },
    passwordless: {
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Lai turpinātu, lūdzu, piekrītiet tālāk sniegtajiem pakalpojumu sniegšanas noteikumiem.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Lūdzu, ievadiet savu e-pasta adresi. Mēs jums nosūtīsim e-pasta ziņojumu paroles atiestatīšanai.',
  ...
  passwordlessEmailAlternativeInstructions: 'Vai arī ievadiet savu e-pasta adresi, lai pierakstītos<br/>vai izveidotu kontu',
  passwordlessEmailCodeInstructions: 'E-pasta ziņojums ar kodu ir nosūtīts uz adresi %s.',
  passwordlessEmailInstructions: 'Ievadiet savu e-pasta adresi, lai pieteiktos<br/>vai izveidotu kontu',
  ...
  usernameFormatErrorHint: 'Izmantojiet burtus %d–%d, ciparus un tālāk norādītās rakstzīmes: “_”, “.”, “+”, “-”',
