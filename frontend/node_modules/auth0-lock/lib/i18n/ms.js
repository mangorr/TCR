...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Domain e-mel anda merupakan sebahagian daripada penyedia identiti Perusahaan. Untuk menetapkan semula kata laluan anda, sila berjumpa dengan pentadbir keselamatan anda.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'Pengesahan berbilang faktor diperlukan tetapi peranti anda tidak didaftarkan. Sila daftarkannya sebelum meneruskan.',
      'lock.mfa_invalid_code': 'Kod tidak betul. Sila cuba lagi.',
      password_change_required: 'Anda perlu mengemas kini kata laluan anda kerana ini merupakan kali pertama anda mengelog masuk, atau kerana kata laluan anda telah tamat tempoh.',
      password_leaked: 'Kami telah mengesan isu keselamatan yang berpotensi dengan akaun ini. Untuk melindungi akaun anda, kami telah menyekat log masuk ini. E-mel dengan arahan tentang cara membuka sekatan akaun anda telah dihantar.',
      too_many_attempts: 'Akaun anda telah disekat selepas berbilang percubaan log masuk yang berturut-turut.',
      session_missing: 'Tidak dapat menyelesaikan permintaan pengesahan anda. Sila cuba lagi selepas menutup semua dialog yang terbuka',
      ...
      too_many_requests: 'Kami minta maaf. Terlalu banyak permintaan sekarang. Muat semula halaman dan cuba lagi. Sekiranya ini berterusan, cuba lagi kemudian.'
    },
    passwordless: {
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Harap bersetuju dengan Syarat Perkhidmatan di bawah untuk meneruskan.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Sila masukkan alamat e-mel anda. Kami akan menghantar e-mel kepada anda untuk menetapkan semula kata laluan anda.',
  ...
  passwordlessEmailAlternativeInstructions: 'Jika tidak, masukkan e-mel anda untuk log masuk<br/>atau mencipta akaun',
