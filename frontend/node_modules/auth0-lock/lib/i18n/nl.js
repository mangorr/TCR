...
exports.default = {
  error: {
    forgotPassword: {
      ...
      'lock.fallback': 'Onze excuses, er is iets fout gegaan bij de de aanvraag voor een wachtwoord wijziging.',
      enterprise_email: 'Het domein van uw e-mail maakt deel uit van een Enterprise-identiteitsprovider. Raadpleeg uw beveiligingsbeheerder om uw wachtwoord opnieuw in te stellen.'
    },
    login: {
      ...
      'lock.network': 'Server is niet bereikbaar. Controleer uw netwerkverbinding en probeer het nog een keer.',
      ...
      password_leaked: 'Dit account is geblokkeerd omdat uw wachtwoord is gelekt op een andere website. We hebben u een e-mail gestuurd met instructies voor het deblokkeren.',
      ...
      session_missing: 'Kan uw authenticatie verzoek niet voltooien. Probeer het opnieuw na het sluiten van alle geopende vensters',
      'hrd.not_matching_email': 'Gelieve gebruik te maken van uw zakelijke e-mail om in te loggen.',
      too_many_requests: 'Het spijt ons. Er zijn op dit moment te veel aanvragen. Laad de pagina opnieuw en probeer het opnieuw. Als dit probleem aanhoudt, probeert u het later opnieuw.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Ga akkoord met de onderstaande servicevoorwaarden om door te gaan.'
    }
  },
  success: {
  ...
  signUpTerms: 'Door u aan te melden gaat u akkoord met onze servicevoorwaarden en ons privacybeleid.',
