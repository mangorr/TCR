...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'E-postdomenet ditt er ein del av ein Enterprise Identity-leverandør. For å tilbakestille passordet, ver venleg og kontakt din sikkerheitsadministrator.'
    },
    login: {
      ...
      'lock.network': 'Får ikkje kontakt med tenaren, ver venleg og kontroller di dekning eller nettverkstilkopling, og prøv på nytt.',
      ...
      password_change_required: 'Du må oppdatere ditt passord, fordi dette anten er den fyrste gongen du loggar inn, eller at ditt passord har gått ut.',
      password_leaked: 'Vi har oppdaga ein potensiell sikkerheitsrisiko med denne brukarkontoen. For å beskytte deg mot misbruk har vi blokkert brukarkontoen med den aktuelle innlogginga. Vi har sendt deg ein e-post med instruksjonar for korleis du opnar brukerkontoen din igjen.',
      too_many_attempts: 'Din brukarkonto har blitt blokkert etter gjentekne ugyldige innloggingsforsøk.',
      session_missing: 'Vi kunne ikkje fullføre førespurnaden om autorisering. Prøv å lukke andre opne faner eller vindauge, og prøv på nytt.',
      'hrd.not_matching_email': 'Ver venleg og bruk di korrekte e-postadresse for innlogging.',
      'lock.mfa_registration_required': 'Multifaktorautentisering krevast, men enheten din er ikkje påmeldt. Ver venleg og meld deg inn før du går vidare.',
      too_many_requests: 'Vi er lei oss. Det er for mange forespørsler akkurat nå. Vennligst last siden og prøv igjen. Hvis dette vedvarer, vennligst prøv igjen senere.',
  ...
  enterpriseActiveLoginInstructions: 'Ver venleg og tast inn dine offisielle innloggingsdetaljar på %s.',
  failedLabel: 'Feil!',
  forgotPasswordTitle: 'Nullstill ditt passord',
  forgotPasswordAction: 'Har du gløymt ditt passord?',
  forgotPasswordInstructions: 'Ver venleg og skriv inn di e-postadresse, og vi vil sende deg ein e-post der du kan nullstille ditt passord.',
  ...
  passwordlessEmailAlternativeInstructions: 'Eller, skriv inn di e-postadresse for å logge inn <br/> eller opprette ein brukerkonto',
  passwordlessEmailCodeInstructions: 'Ein e-post med kode har blitt sendt til %s.',
  passwordlessEmailInstructions: 'Skriv inn di e-postadresse for å logge inn<br/>eller opprette ein brukarkonto',
