...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Du har nådd grensen for antall forsøk på å endre passord. Vennligst vent en stund før du forsøker på nytt',
      'lock.fallback': 'Beklager, men noe gikk galt når du forsøkte å endre passordet.',
      enterprise_email: 'E-postdomenet ditt er en del av en Enterprise Identity-leverandør. For å tilbakestille passordet, vennligst se din sikkerhetsadministrator.'
    },
    login: {
      ...
      'lock.network': 'Får ikke kontakt med serveren, vennligst kontrollèr din dekning eller nettverkstilkobling, og forsøk på nytt.',
      ...
      password_change_required: 'Du må oppdatere ditt passord, fordi dette enten er den første gangen du logger inn, eller at ditt passord har utløpt.',
      password_leaked: 'Vi har oppdaget en potensiell sikkerhetsrisiko med denne brukerkontoen. For å beskytte deg mot misbruk, så har vi blokkert brukerkontoen med den aktuelle innloggingen. Vi har sendt deg en e-post med instruksjoner for hvordan du gjenåpner brukerkontoen din.',
      too_many_attempts: 'Din brukerkonto har blitt blokkert etter gjentatte ugyldige innloggingsforsøk.',
      session_missing: 'Vi kunne ikke fullføre forespørselen om autorisering. Forsøk å lukke andre åpne faner eller vinduer, og prøv på nytt.',
      'hrd.not_matching_email': 'Vennligst bruk din korrekte e-postadresse for innlogging.',
      'lock.mfa_registration_required': 'Multifaktorautentisering kreves, men enheten din er ikke påmeldt. Vennligst meld deg inn før du går videre.',
  ...
  enterpriseActiveLoginInstructions: 'Vennligst tast inn dine offisielle innloggingsdetaljer på %s.',
  failedLabel: 'Feil!',
  forgotPasswordTitle: 'Nullstill ditt passord',
  forgotPasswordAction: 'Har du glemt ditt passord?',
  forgotPasswordInstructions: 'Vennligst skriv inn din e-postadresse, og vi vil sende deg en e-post hvor du kan nullstille ditt passord.',
  ...
  passwordlessEmailAlternativeInstructions: 'Eller, skriv inn din e-postadresse for å logge inn <br/> eller opprette en brukerkonto',
  passwordlessEmailCodeInstructions: 'En e-post med kode har blitt sendt til %s.',
  passwordlessEmailInstructions: 'Skriv inn din e-postadresse for å logge inn<br/>eller opprette en brukerkonto',
