...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Domena Twojego adresu e-mail jest częścią dostawcy tożsamości korporacyjnej. Aby zresetować hasło, skontaktuj się z administratorem bezpieczeństwa.'
    },
    login: {
      ...
      too_many_requests: 'Przykro nam. W tej chwili jest zbyt wiele żądań. Załaduj ponownie stronę i spróbuj ponownie. Jeśli problem będzie się powtarzał, spróbuj ponownie później.',
  ...
  signUpTerms: 'Rejestrując się, akceptujesz nasze warunki korzystania z usługi i politykę prywatności.',
