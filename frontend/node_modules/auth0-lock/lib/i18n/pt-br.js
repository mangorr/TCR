...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: "O domínio do seu e-mail faz parte de um provedor de identidade 'Enterprise'. Para redefinir sua senha, consulte seu administrador de segurança."
    },
    login: {
      ...
      'lock.mfa_registration_required': 'Autenticação por vários fatores é necessária, mas o dispositivo não está inscrito. Por favor, o inscreva antes de prosseguir.',
      ...
      too_many_requests: 'Sentimos muito, mas existem muitos acessos agora. Por favor, recarregue a página e tente novamente. Se isso persistir, tente novamente mais tarde.',
  ...
  forgotPasswordInstructions: 'Por favor digite seu endereço de email. Enviaremos um email para redefinir sua senha.',
  ...
  signUpTerms: 'Ao se inscrever, você concorda com nossos termos de serviço e política de privacidade.',
