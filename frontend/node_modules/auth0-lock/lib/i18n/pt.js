...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Foi atingido o limite de tentativas de alteração da palavra-passe. Aguarde antes de tentar novamente.',
      'lock.fallback': 'Lamentamos, ocorreu um problema ao solicitar a alteração da palavra-passe.',
      enterprise_email: 'O domínio do seu endereço eletrónico é parte de um fornecedor de identidade empresarial. Para repor a sua palavra-passe, consulte o seu administrador de segurança.'
    },
    login: {
      ...
      'lock.network': 'Não foi possível comunicar com o servidor Verifique a sua ligação e tente novamente.',
      ...
      password_change_required: 'Tem de atualizar a sua palavra-passe porque é a primeira vez que está a iniciar sessão ou porque a palavra-passe expirou.',
      password_leaked: 'Foi detetado um possível problema de segurança nesta conta. Para proteger a sua conta, o início de sessão foi bloqueado. Foi enviada uma mensagem eletrónica com instruções sobre como desbloquear a conta.',
      too_many_attempts: 'A sua conta foi bloqueada após várias tentativas sucessivas de início de sessão.',
      'lock.mfa_registration_required': 'É necessária a autenticação multifator, mas o seu dispositivo não está inscrito. Inscreva-o antes de avançar.',
      'lock.mfa_invalid_code': 'Código errado. Tente novamente.',
      session_missing: 'Não foi possível concluir o seu pedido de autenticação. Tente novamente após ter fechado todas as caixas de diálogo abertas',
      'hrd.not_matching_email': 'Utilize o seu endereço de correio eletrónico empresarial para iniciar sessão.',
      too_many_requests: 'Nós lamentamos. Existem muitos pedidos agora. Por favor, recarregue a página e tente denovo. Se isso persistir, tente novamente mais tarde.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Concorde com os Termos de Serviço abaixo para continuar.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Introduza o seu endereço de correio eletrónico. Enviar-lhe-emos uma mensagem eletrónica para repor a palavra-passe.',
  ...
  passwordStrength: {
    ...
    identicalChars: 'Não mais do que %d caracteres idênticos consecutivos (por ex., "%s" não é permitido)',
  ...
  passwordlessEmailAlternativeInstructions: 'Caso contrário, introduza o seu endereço de correio eletrónico para iniciar sessão<br/>ou criar uma conta',
  passwordlessEmailCodeInstructions: 'Foi enviada uma mensagem eletrónica com o código para %s.',
  passwordlessEmailInstructions: 'Introduza o seu endereço de correio eletrónico para iniciar sessão<br/>ou criar uma conta',
  ...
  signUpTerms: 'Ao registar-se, está a aceitar os nossos termos de serviço e a nossa política de privacidade.',
