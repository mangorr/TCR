...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Ai depășit limita de introducere a parolei. Avem rugămintea să aștepți până la următoarea încercare.',
      'lock.fallback': 'Ne pare rău, a apărut o eroare în procesul de recuperare a parolei.',
      enterprise_email: 'Domeniul e-mailului dvs. face parte dintr-un furnizor de identitate de tip Enterprise. Pentru a reseta parola, consultați administratorul de securitate.'
    },
    login: {
      ...
      'lock.network': 'Nu am putut să ne conectăm la server. Avem rugămintea să verifici conexiunea și să încerci din nou.',
      ...
      'lock.mfa_registration_required': 'Dispozitivul tău nu permite conectarea. Avem rugămintea să verifici setările.',
      'lock.mfa_invalid_code': 'Cod greșit. Te rugăm să încerci din nou',
      password_change_required: 'Trebuie să schimbi parola de acces. Parola a expirat sau este prima oară când te conectezi.',
      password_leaked: 'Am identificat o posibilă problemă de securitate cu acest cont. Am blocat contul pentru a te proteja. Urmează să primești un email cu instrucțiunile de deblocare a contului',
      too_many_attempts: 'Contul tău a fost blocat după mai multe încercări nereușite de conectare.',
      session_missing: 'Nu am putut finaliza procesul de autentificare. Avem rugămintea să încerci după ce închizi toate ferestrele deschise.',
      'hrd.not_matching_email': 'Te rugăm să folosești adresa de email corporate pentru conectare.',
      too_many_requests: 'Ne pare rău. Sunt prea multe cereri chiar acum. Reîncărcați pagina și încercați din nou. Dacă acest lucru persistă, încercați din nou mai târziu.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Vă rugăm să acceptați Termenii și condițiile de mai jos pentru a continua.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Avem rugămintea să introduci adresa de email. Urmează să primești un email pentru resetarea parolei.',
  ...
  passwordlessEmailAlternativeInstructions: 'Dacă nu, introdu adresa de email pentru conectare<br/>sau creează un cont.',
  ...
  submitLabel: 'Trimite',
  unrecoverableError: 'Ceva nu a mers.<br />Avem rugămintea să contactezi serviciul de suport tehnic.',
  ...
  signUpTerms: 'Prin înscrierea dvs. sunteți de acord cu termenii și condițiile noastre de utilizare și de politică de confidențialitate.',
