...
exports.default = {
  error: {
    ...
    login: {
      ...
      session_missing: 'Не удалось выполнить запрос аутентификации. Пожалуйста, попробуйте еще раз после закрытия всех открытых диалоговых окон',
      'hrd.not_matching_email': 'Пожалуйста, используйте вашу корпоративную электронную почту для входа.',
      too_many_requests: 'Мы сожалеем. Сейчас слишком много запросов. Пожалуйста, обновите страницу и попробуйте еще раз. Если это не помогло, повторите попытку позже.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Пожалуйста, согласитесь с Условиями обслуживания ниже, чтобы продолжить.'
    }
  },
  success: {
  ...
  signUpTerms: 'Зарегистрировавшись, вы соглашаетесь с нашими условиями обслуживания и политикой конфиденциальности.',
