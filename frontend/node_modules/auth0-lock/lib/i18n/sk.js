...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Doména vášho e-mailu je súčasťou poskytovateľa Enterprise Identity. Ak chcete obnoviť svoje heslo, navštívte správcu zabezpečenia.'
    },
    login: {
      ...
      too_many_requests: 'Je nám to ľúto. Momentálne je príliš veľa žiadostí. Načítajte stránku znova a skúste to znova. Ak to pretrváva, skúste to znova neskôr.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Ak chcete pokračovať, súhlaste so Zmluvnými podmienkami uvedenými nižšie.'
    }
  },
  success: {
  ...
  signUpTerms: 'Registráciou vyjadrujete súhlas s našimi zmluvnými podmienkami a pravidlami ochrany osobných údajov.',
