...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Dosegli ste omejitev števila poskusov spremembe gesla. Pred ponovnim poskusom morate počakati.',
      'lock.fallback': 'Žal je prišlo do napake pri zahtevi za spremembo gesla.',
      enterprise_email: 'Domena vašega e-poštnega naslova je del ponudnika identitete podjetja. Če želite ponastaviti geslo, obiščite svojega skrbnika za varnost.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'Zahtevana je večstranska avtentikacija, a vaša naprava ni vpisana. Pred nadaljevanjem vpišite svojo napravo.',
      'lock.mfa_invalid_code': 'Napačna koda. Poskusite ponovno.',
      password_change_required: 'Svoje geslo morate spremeniti, ker je to vaša prva prijava ali pa je vaše geslo poteklo.',
      password_leaked: 'Zaznali smo morebitno varnostno težavo s tem računom. Za zaščito računa smo blokirali prijavo. Poslali smo vam e-pošto z navodili za odblokiranje računa.',
      too_many_attempts: 'Po več zaporednih poskusih napačne prijave je bil vaš račun blokiran.',
      session_missing: 'Zahteve za avtentikacijo ni bilo možno izpolniti. Zaprite vsa pogovorna okna in poskusite ponovno.',
      'hrd.not_matching_email': 'Za prijavo uporabite svoj službeni e-poštni naslov.',
      too_many_requests: 'Žal nam je. Trenutno je preveč zahtev. Ponovno naložite stran in poskusite znova. Če se to ponavlja, poskusite znova pozneje.',
  ...
  forgotPasswordInstructions: 'Vnesite svoj e-poštni naslov. Poslali vam bomo sporočilo za ponastavitev gesla.',
  ...
  passwordlessEmailAlternativeInstructions: 'Lahko tudi vnesete svoj e-poštni naslov za prijavo<br/>ali ustvarjanje računa',
  passwordlessEmailCodeInstructions: 'Poslali smo e-pošto s kodo na naslov %s.',
  passwordlessEmailInstructions: 'Vnesite svoj e-poštni naslov za prijavo<br/>ali ustvarjanje računa',
