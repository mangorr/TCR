...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Dostigli ste ograničenje broja pokušaja promene lozinke. Sačekajte pre nego što pokušate ponovo.',
      'lock.fallback': 'Žao nam je, došlo je do greške prilikom slanja zahteva za promenu lozinke.',
      enterprise_email: 'Domen vaše adrese e-pošte pripada kompanijskom dobavljaču identiteta. Da biste ponovo postavili lozinku, obratite se administratoru bezbednosti.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'Potrebna je višestruka potvrda identiteta, ali vaš uređaj nije registrovan. Registrujte ga pre nego što nastavite.',
      'lock.mfa_invalid_code': 'Pogrešan kôd. Pokušajte ponovo.',
      password_change_required: 'Morate ažurirati lozinku pošto je ovo prvi put da se prijavljujete ili zbog toga što je lozinka istekla.',
      password_leaked: 'Otkrili smo potencijalni bezbednosni problem sa vašim nalogom. Da bismo zaštitili vaš nalog, blokirali smo ovo prijavljivanje. Poslali smo vam e-poruku koja sadrži uputstvo za deblokadu naloga.',
      too_many_attempts: 'Vaš nalog je blokiran nakon više uzastopnih pokušaja prijavljivanja.',
      session_missing: 'Nije bilo moguće ispuniti vaš zahtev za potvrdu identiteta. Pokušajte ponovo nakon što zatvorite sve otvorene dijaloge',
      ...
      too_many_requests: 'Жао нам је. Тренутно има превише захтева. Поново учитајте страницу и покушајте поново. Ако се то настави, покушајте поново касније.'
    },
    passwordless: {
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Прихватите доле наведене Услове услуге да бисте наставили.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Unesite adresu e-pošte. Poslaćemo vam e-poruku za ponovno postavljanje lozinke.',
  ...
  passwordlessEmailAlternativeInstructions: 'U suprotnom, unesite adresu e-pošte da biste se prijavili<br/> ili kreirajte nalog',
