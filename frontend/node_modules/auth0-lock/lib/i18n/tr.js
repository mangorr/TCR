...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'E-postanızın alanı, bir kurumsal kimlik sağlayıcısının parçasıdır. Parolanızı sıfırlamak için lütfen güvenlik yöneticinize başvurun.'
    },
    login: {
      ...
      'lock.mfa_registration_required': 'Çok faktörlü kimlik doğrulama gerekmektedir ancak cihazınız kayıtlı değil. Devam etmeden önce lütfen cihazınızı kaydettirin.',
      'lock.mfa_invalid_code': 'Hatalı kod. Lütfen tekrar deneyin.',
      password_change_required: 'İlk defa giriş yaptığınız veya şifrenizin kullanım süresi dolduğu için şifrenizi güncellenmeniz gerekmektedir.',
      password_leaked: 'Şifreniz başka bir websitesinde açığa çıktığı için bu giriş denemesi engellendi. Engeli kaldırmak için gereken adımları size e-posta olarak gönderdik.',
      too_many_attempts: 'Çok fazla giriş denemesi sonucunda hesabınız bloke oldu.',
      session_missing: 'Kimlik doğrulama isteği tamamlanamadı. Tüm açık diyalogları kapattıktan sonra tekrar deneyiniz',
      'hrd.not_matching_email': ', Giriş için kurumsal e-posta kullanın.',
      too_many_requests: 'Üzgünüz. Şu anda çok fazla istek var. Lütfen sayfayı tekrar yükleyin ve tekrar deneyin. Bu devam ederse, lütfen daha sonra tekrar deneyin.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: "Devam etmek için lütfen aşağıdaki Hizmet Şartları'nı kabul edin."
    }
  },
  success: {
  ...
  passwordlessEmailAlternativeInstructions: 'Aksi halde, giriş yapmak için e-posta adresinizi girin<br/>veya bir hesap oluşturun',
  passwordlessEmailCodeInstructions: '%s adresine kod içeren bir e-posta gönderildi.',
  passwordlessEmailInstructions: 'Giriş yapmak için e-posta adresinizi girin<br/>veya bir hesap oluşturun',
