...
exports.default = {
  error: {
    forgotPassword: {
      too_many_requests: 'Ви досягли обмеження на кількість спроб зміни пароля. Почекайте, перш ніж продовжити спроби.',
      'lock.fallback': 'На жаль, при запиті на заміну пароля сталася помилка.',
      enterprise_email: 'Ваш домен електронної пошти є частиною постачальника корпоративної ідентифікації. Щоб скинути свій пароль, зверніться до адміністратора безпеки.'
    },
    login: {
      ...
      'lock.network': 'Не вдалося зв’язатися з сервером. Перевірте з’єднання та повторіть спробу пізніше.',
      'lock.popup_closed': 'Спливаюче вікно закрите. Повторіть спробу.',
      'lock.unauthorized': 'Дозволи не надані. Повторіть спробу.',
      'lock.mfa_registration_required': 'Потрібна багатофакторна автентифікація, але пристрій не призначений. Призначте його перед продовженням.',
      'lock.mfa_invalid_code': 'Неправильний код. Повторіть спробу.',
      password_change_required: 'Вам потрібно оновити пароль, оскільки ви вперше входите в систему або оскільки термін дії пароля закінчився.',
      password_leaked: 'У цьому обліковому записі виявлено потенційну проблему, що стосується безпеки. Для захисту вашого облікового запису ми заблокували цей логін. Вам надіслано електронне повідомлення з інформацією, як розблокувати обліковий запис.',
      too_many_attempts: 'Ваш обліковий запис заблоковано після декількох послідовних спроб входу в систему.',
      session_missing: 'Не вдалося виконати запит на автентифікацію. Повторіть спробу, закривши усі відкриті діалогові вікна',
      ...
      too_many_requests: 'Нам шкода. Зараз занадто багато запитів. Перезавантажте сторінку та повторіть спробу. Якщо це триває, спробуйте знову пізніше.'
    },
    passwordless: {
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Прийміть наведені нижче Умови надання послуг, щоб продовжити.'
    }
  },
  success: {
  ...
  forgotPasswordInstructions: 'Введіть свою адресу електронної пошти. Ми надішлемо вам електронного листа для скидання пароля.',
  ...
  passwordlessEmailAlternativeInstructions: 'В іншому випадку введіть адресу електронної пошти, щоб увійти в <br/> або створити обліковий запис',
  passwordlessEmailCodeInstructions: 'Електронне повідомлення з кодом відправлено на %s.',
  passwordlessEmailInstructions: 'Введіть адресу електронної пошти, щоб увійти в <br/> або створити обліковий запис',
  ...
  signUpTerms: 'Реєструючись, ви виражаєте свою згоду з умовами надання послуг та політикою конфіденційності.',
  ...
  usernameFormatErrorHint: 'Використайте %d-%d літер, цифр та наступних символів: "_", ".", "+", "-"',
