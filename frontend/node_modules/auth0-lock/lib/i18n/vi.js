...
exports.default = {
  error: {
    forgotPassword: {
      ...
      enterprise_email: 'Tên miền email của bạn là một phần của một nhà cung cấp nhận dạng doanh nghiệp. Để đặt lại mật khẩu của bạn, vui lòng xem quản trị viên bảo mật của bạn.'
    },
    login: {
      ...
      too_many_requests: 'Chúng tôi xin lỗi. Có quá nhiều yêu cầu ngay bây giờ. Hãy tải lại trang và thử lại. Nếu điều này vẫn còn, vui lòng thử lại sau.',
    ...
    signUp: {
      ...
      social_signup_needs_terms_acception: 'Vui lòng đồng ý với Điều khoản dịch vụ bên dưới để tiếp tục.'
    }
  },
  success: {
  ...
  signUpTerms: 'Bằng cách đăng ký, bạn đồng ý với các điều khoản dịch vụ và chính sách bảo mật của chúng tôi.',
